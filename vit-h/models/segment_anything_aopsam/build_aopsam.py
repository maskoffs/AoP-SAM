...
def build_aopsam_vit_h(args, checkpoint=None):
...
build_aopsam = build_aopsam_vit_h


aopsam_model_registry = {
    "vit_h": build_aopsam_vit_h,
}
...
def _build_aopsam(
    ...
    if checkpoint is not None:
        ...
        try:
            ...
            new_state_dict = load_method(aopsam, state_dict, image_size, patch_size, [7, 15, 23, 31])
