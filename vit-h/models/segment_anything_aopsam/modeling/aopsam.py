...
class AoPSAM(nn.Module):
    ...
    def __init__(
        ...
        for n, value in self.image_encoder.named_parameters():
            if 'cnn_embed' in n or "pos_embed_proj" in n or "CBAtt" in n or "Adapter" in n or "7.attn.rel_pos" in n or "15.attn.rel_pos" in n or "23.attn.rel_pos" in n or "31.attn.rel_pos" in n or "neck" in n:
